 ...
 * @constructor
 */
const Script = exports.Script = function Script(config) {
  ...
  try {
    ...
    if (loc) {
      ...
      const line = lines[loc.line - 1].substring(0, loc.column + 4);
...
Script.prototype._getProvides = function() {
  let base = false;
  let provides = this._ast.body.reduce(function(provides, statement) {
